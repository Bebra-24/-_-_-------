...
namespace WpfApp1
{
    public partial class SecurityTerminalWindow : Window
    {
        ...
        public SecurityTerminalWindow(int employeeId, string employeeName)
        {
            InitializeComponent();
            ...
            if (UserInfoText != null)
                UserInfoText.Text = "Сотрудник охраны: " + employeeName;
        ...
        private void RequestsGrid_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (RequestsGrid != null && RequestsGrid.SelectedItem != null)
            {
                ...
                SecurityRequestWorkWindow workWindow = new SecurityRequestWorkWindow(requestId, visitorName, date, purpose, _employeeId, _employeeName);
        ...
        private void OpenDepartmentBtn_Click(object sender, RoutedEventArgs e)
        {
            DepartmentLoginWindow deptLogin = new DepartmentLoginWindow();
            deptLogin.ShowDialog();
        }
